...
ceiling(sqrt(2)) # redondea hacia el techo
trunc(sqrt(2))


sqrt(2)^2-2  # no tener resultados exactos
...
# r no pude trabajar con más de 16 cifras decimales
# caída del challenger

# tipos de redondeos, hacia par
round(1.25,1)
round(1.35,1)

# valor por defecto, digit = 0
round(sqrt(2),0)
round(sqrt(2))

# hay que especificar el parámetro en caso de tener el propio orde 
